/*
QUESTÃO: 753. Cracking the Safe
LINK: https://leetcode.com/problems/cracking-the-safe/description/?envType=problem-list-v2&envId=graph
...
var crackSafe = function (n, k) {
  ...
  function dfs(node) {
    for (let i = 0; i < k; i++) {
      ...
      if (!visited.has(edge)) {
        visited.add(edge);
        const nextNode = edge.substring(1);
        dfs(nextNode);
